const music = new Audio('audio/lata/1.mp3');


const songs = [
    {
        id: 1,
        songName: `Aankhein Khuli<br> 
    ...
    {
        id: 3,
        songName: `Didi Tera Dewar Deewana<br>
         <div class="subtitle">Lata Mangeshkar</div>`,
    ...
    {
        id: 6,
        songName: `Kaanta Laga Bangle Ke Picha <br>
         <div class="subtitle">Lata Mangeshkar</div>`,
    ...
    {
        id: 9,
        songName: `Sheesha Ho Ya Dil Ho <br>
         <div class="subtitle">Lata Mangeshkar</div>`,
    ...
    {
        id: 10,
        songName: `Dil Pardeshi Ho Gya<br>
         <div class="subtitle">Lata Mangeshkar</div>`,
...
Array.from(document.getElementsByClassName('playListPlay')).forEach((e)=>{
    e.addEventListener('click',(el)=>{
        ...
        music.src = `audio/lata/${index}.mp3`;
        poster_master_play.src = `img/lata/${index}.jpg`;
        music.play();
        masterPlay.classList.remove('bi-play-circle');
        masterPlay.classList.add('bi-pause-circle');
        download_music.href = `audio/lata/${index}.mp3`;
